...
ml <- lm(runs ~ hits, data = mlb11)
summary(ml)
ml2 <- lm(runs ~ wins, data = mlb11)
summary(ml2)
ml3 <- lm(runs ~ bat_avg, data = mlb11)
summary(ml3)
```
...
```{r diag}
# type your code for the Exercise here, and Knit
ml <- lm(runs ~ new_obs, data = mlb11)
summary(ml)
ml2 <- lm(runs ~ new_slug, data = mlb11)
summary(ml2)
ml3 <- lm(runs ~ new_onbase, data = mlb11)
summary(ml3)
```
