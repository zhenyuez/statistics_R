...
```{r q10}
# type your code for qbetaQuestion 10 here, and Knit
4+2+3+4+5+4
1+5
```

11. The government recomments that Americans consume approximately 5 servings of fruits per day. Which of the following represents a weak prior that Americans on average follow this recommendation.
<ol>
<li> $Gamma(a = 1, b = 5)$ </li>
<li> $Gamma(a = 5, b = 1)$ </li>
...
qgamma(c(0.05,0.95),shape=x+5,rate=5001)
```
